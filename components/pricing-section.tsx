  ...
  const pricingPlans = [
    {
      ...
      monthlyPrice: "$49",
      annualPrice: "$39",
      description: "Launch HireSevak in a single workflow or location.",
      features: [
        "Up to 2 HireSevak agents",
        "Pre-trained Open Dental verification playbooks",
        "Desktop vision execution on Windows and web",
    ...
    },
    {
      ...
      monthlyPrice: "$129",
      annualPrice: "$99",
      description: "Scale across dental, accounting, and logistics teams.",
      features: [
        "Unlimited insured patient and invoice workflows",
        "Tally, QuickBooks Desktop, and freight templates",
        "API + UI hybrid automations",
    ...
    },
    {
      ...
      monthlyPrice: "Custom",
      annualPrice: "Custom",
      description: "Extend HireSevak across complex, regulated environments.",
      features: [
        "Private fine-tuning of HireSevak VLMs",
        "On-premises deployment and SSO",
        "Unlimited agents and workflows",
        "Enterprise compliance (SOC 2, HIPAA, ISO)",
      ...
      <div className="self-stretch relative flex flex-col justify-center items-center gap-2 py-0">
        <div className="flex flex-col justify-start items-center gap-4">
          <h2 className="text-center text-foreground text-4xl md:text-5xl font-semibold leading-tight md:leading-[40px]">
            Pricing built for frontline operations
          </h2>
          <p className="self-stretch text-center text-muted-foreground text-sm font-medium leading-tight">
            Choose the package that meets your automation needs, from piloting a single office to transforming global
            insurance, accounting, and logistics operations.
          </p>
        </div>
        <div className="pt-4">
        ...
        {pricingPlans.map((plan) => (
          ...
          >
            <div className="self-stretch flex flex-col justify-start items-start gap-6">
              ...
              >
                <div className="px-1.5 flex justify-center items-center gap-2">
                  <span
                    className={`text-center text-sm font-medium leading-tight ${plan.name === "Starter Pilot" ? "text-gray-800" : plan.name === "Operations Suite" ? "text-primary" : "text-zinc-950"}`}
                  >
                    {plan.buttonText}
                  </span>
                </div>
            ...
            <div className="self-stretch flex flex-col justify-start items-start gap-4">
              ...
              >
                {plan.name === "Starter Pilot"
                  ? "Kick off your automation journey:"
                  : plan.name === "Operations Suite"
