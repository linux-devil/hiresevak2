          ...
          <div className="self-stretch flex justify-between items-center">
            <div className="flex-1 px-4 py-8 md:px-12 lg:px-20 md:py-8 lg:py-10 overflow-hidden rounded-lg flex flex-col justify-center items-center gap-6 md:gap-8 lg:gap-11">
              <div className="w-full max-w-[1024px] text-center text-foreground leading-7 md:leading-10 lg:leading-[64px] font-medium text-lg md:text-3xl lg:text-6xl">
                {
                  "HireSevak now checks insurance eligibility before our patients arrive. What took a coordinator an entire morning is done before breakfast and our staff can finally focus on care."
                }
              </div>
              <div className="flex justify-start items-center gap-5">
                <Image
                  src="/images/avatars/darlene-robertson.png"
                  alt="Operations lead at Lakeside Dental"
                  width={48}
                  height={48}
                ...
                <div className="flex flex-col justify-start items-start">
                  <div className="text-foreground text-base font-medium leading-6">Maya Patel</div>
                  <div className="text-muted-foreground text-sm font-normal leading-6">Director of Operations, Lakeside Dental Group</div>
                </div>
              </div>
            </div>
          </div>
